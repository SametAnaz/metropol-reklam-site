          ...
          <AnimatedSection animation="fade-up">
            <div className="mt-16">
              <div className="text-center mb-12">
                <h3 className="text-3xl font-bold mb-4 text-gray-800">Galeri</h3>
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  Çalışmalarımızdan daha fazla örnekleri galeriden keşfedin
                </p>
              </div>
              ...
              <div className="text-center">
                <Link href="/gallery" className="inline-flex items-center space-x-2 bg-white border-2 border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white px-6 py-3 rounded-md font-medium transition-colors duration-200">
